...
package productmanager.application.exception;


import productmanager.application.exception.type.BaseException;
import productmanager.application.exception.type.ValidationException;
